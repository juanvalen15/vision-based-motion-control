...
#
# vMotion.tcl: Tcl script for re-creating project 'vMotion'
#
# Generated by Vivado on Fri May 23 10:43:44 CEST 2025
...
#
# 1. This project restoration tcl script (vMotion.tcl) that was generated.
#
...
set orig_proj_dir "[file normalize "$origin_dir/vMotion"]"
...
set_property -name "platform.description" -value "Vivado generated Hardware Platform for Kria KR260" -objects $obj
...
set_property -name "platform.name" -value "kr260_vMotion" -objects $obj
...
set_property -name "top" -value "kr260_bd_wrapper" -objects $obj
...
# Proc to create BD kr260_bd
proc cr_bd_kr260_bd { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name kr260_bd
...
\
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins axi_intc_0/s_axi]
  ...
  set_property PFM_NAME {xilinx:lib:kr260_vMotion:1.0} [get_files [current_bd_design].bd]
  ...
  set_property PFM.CLOCK {clk_out1 {id "2" is_default "false" proc_sys_reset "/proc_sys_reset_1" status "fixed" freq_hz "100000000"} clk_out2 {id "3" is_default "true" proc_sys_reset "/proc_sys_reset_0" status "fixed" freq_hz "200000000"}} [get_bd_cells /clk_wiz_0]
  set_property PFM.IRQ {intr { id 0 range 32 }} [get_bd_cells /axi_intc_0]
  set_property PFM.AXI_PORT {M01_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "true"} M02_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "true"} M03_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "true"} M04_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "true"} M05_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "true"} M06_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "true"} M07_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "true"} M08_AXI {memport "M_AXI_GP" sptag "" memory "" is_range "true"}} [get_bd_cells /axi_smc]
...
# End of cr_bd_kr260_bd()

cr_bd_kr260_bd ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files kr260_bd.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "0" [get_files kr260_bd.bd ] 
set_property IS_ENABLED "1" [get_files kr260_bd.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files kr260_bd.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files kr260_bd.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files kr260_bd.bd ] 
set_property PFM_NAME "xilinx:lib:kr260_vMotion:1.0" [get_files kr260_bd.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files kr260_bd.bd ] 
set_property SYNTH_CHECKPOINT_MODE "None" [get_files kr260_bd.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files kr260_bd.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files kr260_bd.bd ] 
set_property USED_IN_SIMULATION "1" [get_files kr260_bd.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files kr260_bd.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list kr260_bd.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/vMotion/vMotion.gen/sources_1/bd/kr260_bd/hdl/kr260_bd_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list kr260_bd.bd]] -top]
